	...
	public Login() {
		...
		btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String query = "SELECT * FROM mfortelnyy_users WHERE uname = ? and upass = ?;";
				try (PreparedStatement stmt = conn.getConnection().prepareStatement(query)) {
					...
					if (rs.next()) {
						...
						username=rs.getString("uname");// get table column value
						new Tickets(admin, getuser()); //open Tickets file / GUI interface
